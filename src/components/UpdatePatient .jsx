      ...
      try {
        ...
        setFormData({
          ...
          bloodCbc: {
            ...
            rdwCV: patientData.bloodCbc?.rdwCV || { value: '', unit: '%', range: '11-16' },
            rdwSD: patientData.bloodCbc?.rdwSD || { value: '', unit: 'fl', range: '35-56'  },
            twbcCount: patientData.bloodCbc?.twbcCount || { value: '', unit: '/cumm', range: '4500-11000' }
          },
          urineTest: {
            ...formData.urineTest,
